...
const settingFields = [
  ...
  'perp_trend_shock_return_enabled',
  'perp_trend_shock_return_lookback_minutes',
  'perp_trend_shock_return_threshold_pct',
...
const SETTING_LABELS: Record<string, string> = {
  ...
  perp_trend_shock_return_enabled: 'Shock BTC — Gamba prezzo',
  perp_trend_shock_return_lookback_minutes: 'Shock BTC — Finestra return (min)',
  perp_trend_shock_return_threshold_pct: 'Shock BTC — Soglia return %',
