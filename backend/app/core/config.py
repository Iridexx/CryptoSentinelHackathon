...
SECTION_FIELD_MAP: dict[str, dict[str, str]] = {
    ...
    "spot": {
        ...
        "max_stop_distance_filter_enabled": "spot_max_stop_distance_filter_enabled",
        "max_stop_distance_pct": "spot_max_stop_distance_pct",
    ...
    "perp": {
        ...
        "trend_shock_require_real_move": "perp_trend_shock_require_real_move",
        ...
        "leverage_mode": "perp_leverage_mode",
        "risk_at_stop_pct": "perp_risk_at_stop_pct",
...
class Settings(BaseSettings):
    ...
    aster_subaccount_name: str = Field(default="CryptoSentinel", alias="ASTER_SUBACCOUNT_NAME")
    ...
    spot_max_stop_distance_filter_enabled: bool = Field(default=True, alias="SPOT_MAX_STOP_DISTANCE_FILTER_ENABLED")
    spot_max_stop_distance_pct: float = Field(default=4.0, alias="SPOT_MAX_STOP_DISTANCE_PCT")
    ...
    # Uno spike di sola volatilita'/volume (NATR percentile + volume relativo, gambe
    # correlate: una candela violenta le fa scattare entrambe) non basta a dichiarare
    # lo shock. Con questo flag il BLOCKED richiede, oltre a score>=2, almeno una
    # gamba di "movimento reale": ADX in trend oppure return assoluto oltre soglia.
    perp_trend_shock_require_real_move: bool = Field(default=True, alias="PERP_TREND_SHOCK_REQUIRE_REAL_MOVE")
    ...
    perp_leverage_mode: str = Field(default="atr", alias="PERP_LEVERAGE_MODE")
    perp_risk_at_stop_pct: float = Field(default=20.0, alias="PERP_RISK_AT_STOP_PCT")
